...
shinyUI(fluidPage(theme = "bootstrap.css",
                      navbarPage('Primary Election',
                             ...
                             tabPanel('Introduction',
                                      ...
                                      tags$a(href="https://www.kaggle.com/benhamner/2016-us-election", "Click here for source"),
                                      br(),
                                      br(),
                                      br(),
                                      p("Project is on GitHub:"),
                                      tags$a(href="https://github.com/wynhsu/final-project-I-mWithHer", "Click here for source"),
                                      br(),
                                      br(),
                                      br(),
